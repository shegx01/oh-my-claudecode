...
function resolveAckPath(cwd, sessionId) {
    if (!sessionId) {
        return null;
    }
    try {
...
function buildGuardMessage(params) {
    ...
    return (`⛔ Branch guard: you are on protected branch "${branch}". Write-capable work is blocked here.\n` +
...
export function processBranchGuard(input) {
    try {
        if (isSkippedViaEnv()) {
            return ALLOW;
        }
