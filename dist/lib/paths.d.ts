 ...
 */
export declare const OMC_PLUGIN_MARKETPLACE_SLUG = "omcx";
export declare const OMC_PLUGIN_PACKAGE_NAME = "oh-my-claudecode";
export declare const OMC_PLUGIN_CACHE_REL = "plugins/cache/omcx/oh-my-claudecode";
export declare const OMC_PLUGIN_MARKETPLACE_REL = "plugins/marketplaces/omcx";
